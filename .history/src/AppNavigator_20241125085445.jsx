...
function FilmsStack() {
    return (
        ...
        >
            ...
            <Stack.Screen name="FavoriteBar" component={FilmsFavoriteBarStack} />
        </Stack.Navigator>
    );
}
...
function TvStack() {
    return (
        ...
        >
            ...
            <Stack.Screen name="FavoriteBar" component={TvProgramsFavoriteBarStack} />
...
function TvProgramsFavoriteBarStack() {
    return (
        <Stack.Navigator
            screenOptions={{
                headerShown: false,
...
function FilmsFavoriteBarStack() {
    return (
        <Stack.Navigator
            screenOptions={{
                headerShown: false,
